...
public class CommodityDAOImpl implements CommodityDAO {
     ...
     * @author Caitong Tang
     */
    public ArrayList<Commodity> LargeclassSearch(String string,String Order) throws Exception {
        ArrayList<Commodity> vogue = new ArrayList<>();
        String sql = "Select * from Commodity Where LargeClass Like ? order by Price "+Order;
        DBConnect dbc = null;
        PreparedStatement ps;
        try {
            dbc = new DBConnect();
     ...
     * @author Caitong Tang
     */
    public ArrayList<Commodity> SmallclassSearch(String string,String Order) throws Exception {
        ArrayList<Commodity> vogue = new ArrayList<>();
